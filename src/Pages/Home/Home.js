import { MenuFoldOutlined, MenuUnfoldOutlined, ReadOutlined, CodeSandboxCircleFilled } from '@ant-design/icons';
  ...
  return (
    <Layout className={style['wrapper']}>
      <Sider collapsed={collapsed}>
        ...
        <Menu theme="dark" mode="inline" defaultSelectedKeys={['1']} items={items} onClick={changeContent} />
      </Sider>
      <Layout>
